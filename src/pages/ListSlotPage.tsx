  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] text-[#1d1d1f]">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-24 pb-24">
        ...
        {/* Easier options — surfaced prominently */}
        {step === 1 && (
          <div className="mb-8 bg-white border border-black/[0.06] rounded-3xl p-5 shadow-sm">
            <p className="text-[#1d1d1f] font-semibold text-[13px] mb-1">Prefer not to fill a form?</p>
            <p className="text-[#6e6e73] text-[13px] mb-4">Send us your slot details by email and we'll create the listing for you — or upload a CSV if you have multiple slots.</p>
